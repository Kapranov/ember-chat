...
define('socketry/controllers/websocket', ['exports', 'ember'], function (exports, Ember) {
...
define('socketry/tests/controllers/websocket.jshint', function () {

  'use strict';

  module('JSHint - controllers');
  test('controllers/websocket.js should pass jshint', function() { 
    ok(true, 'controllers/websocket.js should pass jshint.'); 
  });
...
if (runningTests) {
  ...
  require("socketry/app")["default"].create({"name":"socketry","version":"0.0.0.0bd5a2f0"});
}
